                        ...
                        <div className="card mb-3 mx-auto bg-dark text-light">
                            <div className="row g-0">
                                <div className="col-md-4">
                                    ...
                                    < img src="https://media.istockphoto.com/id/1398196518/es/foto/%C3%A1rbol-de-banyan-frente-a-la-impresionante-puesta-de-sol.jpg?s=612x612&w=0&k=20&c=xBC9-AngZk699g-nwfrlB_96yOyrB6hhN8DNe08n2h0=" className="img-fluid rounded-start" alt=".." />
                                </div>
